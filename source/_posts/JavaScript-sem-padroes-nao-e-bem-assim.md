...
- [socket.io](https://www.npmjs.com/package/socket.io): Usando como _adapter_ do Primus ou não, o `Socket.IO` é a biblioteca de socket mais usada pela comunidade do Node. Na dúvida, escolha o `Socket.IO`, data a quantidade de _features_ e aplicações grandes que o usa.
